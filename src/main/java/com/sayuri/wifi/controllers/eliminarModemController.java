...
public class eliminarModemController {
    ...
    @FXML
    private TableColumn<Producto, Integer> c3Table;

    @FXML
    private TableColumn<Producto, String> c4Table;
    ...
    void initialize() {
        ...
        c3Table.setCellValueFactory(new PropertyValueFactory<>("Velocidad"));
        c4Table.setCellValueFactory(new PropertyValueFactory<>("TipoModem"));
    }
}
