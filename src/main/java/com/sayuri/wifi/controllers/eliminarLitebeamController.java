...
public class eliminarLitebeamController {
    ...
    void bttonVer(MouseEvent event) {
        ...
        for (Producto producto : admin.getListProduct()) {
            if (producto instanceof LitebeamM5) {
    ...
    void initialize() {
        ...
        c3Table.setCellValueFactory(new PropertyValueFactory<>("TipoConexion"));
        c4Table.setCellValueFactory(new PropertyValueFactory<>("PotenciaTransmicion"));
    }
}
